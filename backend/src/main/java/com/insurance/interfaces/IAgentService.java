...
public interface IAgentService {
	...
	PagedResponse<AgentResponse> getAllAgents(int page, int size, String sortBy, String direction, String searchQuery);

	AgentResponse getAgentById(String agent_id);
