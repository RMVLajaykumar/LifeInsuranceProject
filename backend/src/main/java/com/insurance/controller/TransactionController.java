...
public class TransactionController {
    ...
    @GetMapping("/transactions-with-params/{policyid}")
    @PreAuthorize("hasRole('CUSTOMER')")
    @Operation(summary = "Get all transactions by policy id with pagination and sorting")
    public ResponseEntity<PagedResponse<TransactionResponse>> transactionWithParamsByPolicyId(
        ...
        return new ResponseEntity<>(service.transactionWithParamsByPolicyId(policyid, page, size, sortBy, direction), HttpStatus.OK);
    }
